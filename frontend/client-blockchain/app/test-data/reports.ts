import { ResponseResourceUsageDto } from "@/app/definations/report-details";

export const reports: ResponseResourceUsageDto[] = [
  {
    username: "nguyenvana",
    electric: {
    ...
    water: {
      amount_water: 12.4,
      invoice_water: "https://images.unsplash.com/photo-1546500840-ae38253aba9b?auto=format",
    },
    carbon: 45.2,
    dataHash: "8f42a6b2d9e1f5c3a7b8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0",
    address_transaction: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
  ...
  },
  {
    ...
    address_transaction: "0x25451A09129f1F962402c43E5c59f24E766E3871",
  ...
  },
  {
    ...
    electric: {
      ...
      invoice_electric: "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format",
    },
    water: {
      amount_water: 8.5,
    ...
    address_transaction: "0x1234567890ABCDEF1234567890ABCDEF12345678",
  ...
  },
  {
    ...
    carbon: 31.4,
    dataHash: "9a8b7c6d5e4f3a2b1c0d9e8f7a6b5c4d3e2f1a0b9c8d7e6f5a4b3c2d1e0f9a8",
    address_transaction: "0x9876543210FEDCBA9876543210FEDCBA98765432",
  ...
  },
  {
    ...
    carbon: 33.2,
    dataHash: "0f1e2d3c4b5a69788776655443322110ffeedccbbaa99887766554433221100",
    address_transaction: "0x0f1e2d3c4b5a69788776655443322110ffeedccb",
